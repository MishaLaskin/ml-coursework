...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        data_loss = correct_log_probs.sum()/N
        ...
        # y_mask selects the correct classes from probs
        y_mask = np.zeros_like(probs)
        y_mask[range(N),y] = 1
        dscores = (probs - y_mask)/N
    ...
    def train(self, X, y, X_val, y_val,
        ...
        for it in range(num_iters):
            ...
            X_batch, y_batch = X[rand_ids],y[rand_ids]
